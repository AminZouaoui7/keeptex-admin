...
class _PendingOrdersPageState extends State<PendingOrdersPage> {
  late Future<List<CommandeModel>> _pendingOrdersFuture;
  ...
  void refreshData() {
    setState(() {
      _pendingOrdersFuture = _commandeService.getAllCommandes().then(
            (orders) => orders
            .where((order) => order.etat.toLowerCase() == 'en attente')
            .toList(),
      );
    });
  }
